...
Ext.define('App.controller.clientes.ClientesEditController', {
    ...
    //----------------------------------------------------------------------------------------
    onAtualizarClienteClick: function(btn, event, options) {
        ...
        var record = btn.scope.formDadosPrimarios.getRecord();
        ...
        values.codigoTipoDeCliente = tipoDeCliente.data.codigo;
        values.nomeTipoDeCliente = tipoDeCliente.data.nome;
        values.ativoTipoDeCliente = tipoDeCliente.data.ativo;
        values.meiosDeContato = meiosDeContato;
        values.enderecos = enderecos;
        values.ativo = (values.ativo) ? true : false;
