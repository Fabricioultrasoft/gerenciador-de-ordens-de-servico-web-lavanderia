...
// Objeto que cria um ambiente desktop no navegador
Ext.define('App.webDesktop.AppWebDesktop', {
    mixins: {
        observable: 'Ext.util.Observable'
    },
    requires: ['Ext.container.Viewport', 'App.webDesktop.Desktop'],
    isReady: false,
    modules: null,
    useQuickTips: true,
    ...
    init: function () {
        ...
        me.desktop = Ext.create('App.webDesktop.Desktop',desktopCfg);
