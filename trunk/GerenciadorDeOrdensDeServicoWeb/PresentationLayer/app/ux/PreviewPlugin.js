...
Ext.define('App.ux.PreviewPlugin', {
    ...
    alias: 'plugin.preview',
    requires: ['Ext.grid.feature.RowBody', 'Ext.grid.feature.RowWrap', ,'Ext.String','Ext.util.Format'],
     ...
     * String inserida antes da frase no preview
     * para servir como um rotulo.
     */
    labelField: '',
        ...
        var bodyField   = this.bodyField,
            ...
            features = [{
                ...
                getAdditionalData: function(data, idx, record, orig, view) {
                    ...
                    Ext.apply(o, {
                        rowBody: labelField + Ext.String.htmlEncode( data[bodyField] ).replace(/\n/gi,"<br />"),
