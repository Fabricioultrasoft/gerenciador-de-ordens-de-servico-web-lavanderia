...
Ext.define('App.store.ordensDeServico.OrdensDeServicoStore', {
    ...
    listeners: {
        load: function( store, records, successful, eOpts ) {
            if (records.length == 0) {
                Ext.notification.msg("Consulta de Ordens de Servi&ccedil;o", "Nenhum registro encontrado!");
            }
        },
        write: function(proxy, operation){
            if (operation.action == 'destroy') {
                if(operation.resultSet.success) {
                    Ext.notification.msg("Exclus&atilde;o de Ordens de Servi&ccedil;o", "Os registros foram exclu&iacute;dos com sucesso");
                } else {
                    Ext.notification.msg("Exclus&atilde;o de Ordens de Servi&ccedil;o", operation.resultSet.message.join("<br />"));
                }
            }
            try {
